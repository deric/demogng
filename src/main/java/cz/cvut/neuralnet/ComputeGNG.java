...
public class ComputeGNG extends JPanel implements
        Runnable,
        MouseMotionListener,
        MouseListener,
        ComponentListener,
     ...
     */
    public ComputeGNG(CNGPanel graph) {
...
//				}
    ...
    protected int insertColumn(int x) {
        if ((gridWidth == MAX_GRID_X) || (nNodes + gridHeight > maxNodes)) // max size or dimension reached: no further insert!
        {
            return -1;
        }
