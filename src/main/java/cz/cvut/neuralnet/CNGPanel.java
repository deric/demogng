...
public class CNGPanel extends JPanel {
    ...
    private static final long serialVersionUID = 5313599368992087388L;
...
//					}
     ...
     * sizeSOM_As[]. Larger value should be first due to different max values
     * for x and y
     */
...
//		cp_speed.add(sped);
        ...
        String algorithmParam = Algo.CHL.name();
        String distributionParam = PD.Circle.getName();
...
//				stepSize_choice.setSelectedIndex(3);
        ...
        compute.errorGraph = new GraphGNGPanel(this);
